...
namespace Mews.Fiscalizations.TicketBai.Tests
{
    [TestFixture]
    public class Tests
    {
        ...
        public static readonly TicketBaiClient Client = new TicketBaiClient(Certificate, Environment.Test);
        ...
        private Invoice CreateInvoice()
        {
            return new Invoice(
                ...
                taxBreakdown: CreateTaxBreakdown()
            );
        }
        ...
        private InvoiceData CreateInvoiceData()
        {
            return new InvoiceData(
                descripton: String1To250.CreateUnsafe("factura ejemplo TBAI"),
                items: CreateInvoiceItems(),
                totalAmount: 89.36m,
                taxRegulationTypes: TaxRegulationType.GeneralTaxRegimeActivity.ToEnumerable()
            );
        }
