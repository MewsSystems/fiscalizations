<p align="center">
    ...
    <br><br>
    <b>Mews.Fiscalizations.TicketBai</b> is a .NET library that was built to help reporting invoices to TicketBai (TBAI).
    <br><br>
...
Listed below are some of the common examples. If you want to see more code examples, please check the [Tests](https://github.com/MewsSystems/fiscalizations/tree/master/src/TicketBai/Mews.Fiscalizations.TicketBai.Tests).

Please note that you will need a valid certificate in order to use the API, please check the documentation.

Creating the client:
```csharp
var client = new TicketBaiClient(Certificate, Environment.Test);
```
