...
public interface IInfrasecClient
{
    ...
    Task<Try<StatusEnrollmentResponse, Exception>> GetStatusCcuAsync(StatusEnrollmentData data, NonEmptyString applicationId, int? requestId = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token to cancel the request</param>
    /// <returns>The response from the Infrasec API or an exception if the request fails</returns>
    Task<Try<NewEnrollmentResponse, Exception>> EnrollCcuAsync(NewEnrollmentData data, NonEmptyString applicationId, int? requestId = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A cancellation token to cancel the request.</param>
    /// <returns>The response from the Infrasec API or an exception if the request fails.</returns>
    Task<Try<TransactionResponse, Exception>> SendTransactionAsync(TransactionData data, NonEmptyString applicationId, Guid? requestId = null, CancellationToken cancellationToken = default);
}