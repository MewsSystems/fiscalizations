...
public class SendInvoiceTests
{
    ...
    [TestCase(Region.Gipuzkoa, true, false, TestName = "Gipuzkoa - Send complete invoice with local receiver", Ignore = "Gipuzkoa local receiver validation issue")]
    [TestCase(Region.Gipuzkoa, false, false, TestName = "Gipuzkoa - Send complete invoice with foreign receiver")]
    [TestCase(Region.Gipuzkoa, true, true, TestName = "Gipuzkoa - Send complete negative invoice with local receiver", Ignore = "Gipuzkoa local receiver validation issue")]
    ...
    [TestCase(Region.Gipuzkoa, false, TestName = "Gipuzkoa - Complete Invoice chaining", Ignore = "Gipuzkoa local receiver validation issue")]
