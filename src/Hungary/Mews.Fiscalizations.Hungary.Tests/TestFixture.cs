...
namespace Mews.Fiscalizations.Hungary.Tests
{
    ...
    {
        public static readonly TaxpayerIdentificationNumber TaxPayerId = TaxpayerIdentificationNumber.Create(Countries.Hungary, Environment.GetEnvironmentVariable("hungarian_tax_payer_id") ?? "INSERT_TAX_PAYER_ID").Success.Get();
