    ...
    public static class Countries
    {
        static Countries()
        {
            All = NonEmptyEnumerable.Create(
                ...
                Austria = European("AT", regexWithCountryCodePrefix: "^(AT)?U[0-9]{8}$", regexWithoutCountryCodePrefix: "^U[0-9]{8}$"),
                ...
                Belgium = European("BE", regexWithCountryCodePrefix: "^(BE)?0[0-9]{9}$", regexWithoutCountryCodePrefix: "^0[0-9]{9}$"),
                ...
                Bulgaria = European("BG", regexWithCountryCodePrefix: "^(BG)?[0-9]{9,10}$", regexWithoutCountryCodePrefix: "^[0-9]{9,10}$"),
                ...
                Cyprus = European("CY", regexWithCountryCodePrefix: "^(CY)?[0-9]{8}L$", regexWithoutCountryCodePrefix: "^[0-9]{8}L$"),
                CzechRepublic = European("CZ", regexWithCountryCodePrefix: "^(CZ)?[0-9]{8,10}$", regexWithoutCountryCodePrefix: "^[0-9]{8,10}$"),
                Denmark = European("DK", regexWithCountryCodePrefix: "^(DK)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                ...
                Estonia = European("EE", regexWithCountryCodePrefix: "^(EE)?[0-9]{9}$", regexWithoutCountryCodePrefix: "^[0-9]{9}$"),
                Ethiopia = NonEuropean("ET"),
                FalklandIslands = NonEuropean("FK"),
                FaroeIslands = NonEuropean("FO"),
                Fiji = NonEuropean("FJ"),
                Finland = European("FI", regexWithCountryCodePrefix: "^(FI)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                France = European("FR", regexWithCountryCodePrefix: "^(FR)?[0-9A-Z]{2}[0-9]{9}$", regexWithoutCountryCodePrefix: "^[0-9A-Z]{2}[0-9]{9}$"),
                ...
                Germany = European("DE", regexWithCountryCodePrefix: "^(DE)?[0-9]{9}$", regexWithoutCountryCodePrefix: "^[0-9]{9}$"),
                Ghana = NonEuropean("GH"),
                Gibraltar = NonEuropean("GI"),
                Greece = European("GR", regexWithCountryCodePrefix: "^(EL|GR)?[0-9]{9}$", regexWithoutCountryCodePrefix: "^[0-9]{9}$"),
                ...
                Hungary = European("HU", regexWithCountryCodePrefix: "^(HU)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                Iceland = NonEuropean("IS"),
                India = NonEuropean("IN"),
                Indonesia = NonEuropean("ID"),
                Iran = NonEuropean("IR"),
                Iraq = NonEuropean("IQ"),
                Ireland = European("IE", regexWithCountryCodePrefix: "^(IE)?[0-9A-Z]{8}([0-9A-Z]{1})?$", regexWithoutCountryCodePrefix: "^[0-9A-Z]{8}([0-9A-Z]{1})?$"),
                IsleOfMan = NonEuropean("IM"),
                Israel = NonEuropean("IL"),
                Italy = European("IT", regexWithCountryCodePrefix: "^(IT)?[0-9]{11}$", regexWithoutCountryCodePrefix: "^[0-9]{11}$"),
                ...
                Latvia = European("LV", regexWithCountryCodePrefix: "^(LV)?[0-9]{11}$", regexWithoutCountryCodePrefix: "^[0-9]{11}$"),
                Lebanon = NonEuropean("LB"),
                Lesotho = NonEuropean("LS"),
                Liberia = NonEuropean("LR"),
                Libya = NonEuropean("LY"),
                Liechtenstein = NonEuropean("LI"),
                Lithuania = European("LT", regexWithCountryCodePrefix: "^(LT)?([0-9]{9}|[0-9]{12})$", regexWithoutCountryCodePrefix: "^([0-9]{9}|[0-9]{12})$"),
                Luxembourg = European("LU", regexWithCountryCodePrefix: "^(LU)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                ...
                Mali = NonEuropean("ML"),
                Malta = European("MT", regexWithCountryCodePrefix: "^(MT)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                ...
                Netherlands = European("NL", regexWithCountryCodePrefix: "^(NL)?[0-9]{9}B[0-9]{2}$", regexWithoutCountryCodePrefix: "^[0-9]{9}B[0-9]{2}$"),
                ...
                Poland = European("PL", regexWithCountryCodePrefix: "^(PL)?[0-9]{10}$", regexWithoutCountryCodePrefix: "^[0-9]{10}$"),
                Portugal = European("PT", regexWithCountryCodePrefix: "^(PT)?[0-9]{9}$", regexWithoutCountryCodePrefix: "^[0-9]{9}$"),
                PuertoRico = NonEuropean("PR"),
                Qatar = NonEuropean("QA"),
                Romania = European("RO", regexWithCountryCodePrefix: "^(RO)?[0-9]{2,10}$", regexWithoutCountryCodePrefix: "^[0-9]{2,10}$"),
                ...
                Slovakia = European("SK", regexWithCountryCodePrefix: "^(SK)?[0-9]{10}$", regexWithoutCountryCodePrefix: "^[0-9]{10}$"),
                Slovenia = European("SI", regexWithCountryCodePrefix: "^(SI)?[0-9]{8}$", regexWithoutCountryCodePrefix: "^[0-9]{8}$"),
                ...
                Spain = European("ES", regexWithCountryCodePrefix: "^(ES)?[0-9A-Z][0-9]{7}[0-9A-Z]$", regexWithoutCountryCodePrefix: "^[0-9A-Z][0-9]{7}[0-9A-Z]$"),
                ...
                Sweden = European("SE", regexWithCountryCodePrefix: "^(SE)?[0-9]{12}$", regexWithoutCountryCodePrefix: "^[0-9]{12}$"),
                ...
                UnitedKingdom = European("GB", regexWithCountryCodePrefix: "^(GB)?([0-9]{9}([0-9]{3})?|[A-Z]{2}[0-9]{3})$", regexWithoutCountryCodePrefix: "^([0-9]{9}([0-9]{3})?|[A-Z]{2}[0-9]{3})$"),
        ...
        private static Country European(string alpha2Code, string regexWithCountryCodePrefix, string regexWithoutCountryCodePrefix)
        {
            return new Country(new EuropeanUnionCountry(alpha2Code, new Regex(regexWithCountryCodePrefix), new Regex(regexWithCountryCodePrefix)));
        }
